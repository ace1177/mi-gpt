...
export default {
  ...
  speaker: {
    ...
    password: "123456",
    // 小爱音箱 DID 或在米家中设置的名称
    did: "小米AI音响（第二代）", // 注意空格、大小写和错别字（音响 👉 音箱）
    ...
    // 进入 AI 模式的欢迎语
    onEnterAI: ["亲爱的，我们什么时候回南充"], // 设为空数组时可关闭提示语
    // 退出 AI 模式的提示语
    onExitAI: ["蒲蒲先睡觉了"], // 为空时可关闭提示语
    // AI 开始回答时的提示语
    onAIAsking: ["我还是要想一下"], // 为空时可关闭提示语
    // AI 结束回答时的提示语
    onAIReplied: ["大概是这样子"], // 为空时可关闭提示语
    // AI 回答异常时的提示语
    onAIError: ["我不清楚了，过后问吗！"], // 为空时可关闭提示语
